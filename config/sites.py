...
SITES = [
    ...
    },
    {
        ...
        "fetch": fetch_html,
        "parse": rss_parser,
        "build_url": lambda page, t: f"https://asiatimes.com/feed/",
        "params": {
            "news_types": {
                "international": "international"
            },
    ...
    },
    {
        ...
        "fetch": fetch_html,
        "parse": rss_parser,
        "build_url": lambda page, t: f"https://feeds.businessinsider.com/custom/all",
        "params": {
            "news_types": {"international": "international"},
            "total_pages": 1,
        },
    ...
    },
    {
        ...
        "fetch": fetch_html,
        "parse": rss_parser,
        "build_url": lambda page, t: f"https://www.independent.co.uk/news/world/rss",
        "params": {
            "news_types": {
                "international": "international"
            },
    ...
    },
    {
        ...
        "fetch": fetch_html,
        "parse": rss_parser,
        "build_url": lambda page, t: f"https://www.rt.com/rss/news/",
        "params": {
            "news_types": {
                "international": "international",
            },
    ...
    },
    {
        ...
        "fetch": fetch_html,
        "parse": rss_parser,
        "build_url": lambda page, t: f"https://www.hindustantimes.com/feeds/rss/world-news/rssfeed.xml",
        "params": {
            "news_types": {
                "international": "international",
            },
